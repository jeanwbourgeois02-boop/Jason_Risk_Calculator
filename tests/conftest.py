...
def strict_marks(monkeypatch):
    ...
    step-back and the Blotter FX sub-tab's "n/a" cell only ever act on a trade the near
    rule could not price, so their fixtures of "a day with no mark" need the rule out of
    the way (user
