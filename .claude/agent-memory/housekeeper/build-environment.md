...
Known state as of 2026-09-14 (after the `NY` NameError fix, uncommitted at time of writing): 115 passed, 0 failed. Any failure in `tests/test_bloomberg.py` is now a real regression, not the old pre-existing `NameError: NY` (open-questions item 38, resolved).
