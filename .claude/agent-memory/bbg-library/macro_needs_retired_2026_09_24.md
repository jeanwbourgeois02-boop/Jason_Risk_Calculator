...
- HISTORY_INPUT_PRODUCTS and _REALISED_FILTER_PRODUCTS became ("FX_OPTION",) (HISTORY_INPUT_PRODUCTS gained the listed options in Phase 5, see [[phase5-options-lme-library-2026-09-24]]). LIVE_ONLY_KINDS is (CONTRACT_DATES,) and SET_KINDS is (OIS_CURVE, VOL_SMILE).
